...
const Root = () => {
    ...
    useEffect(() => {
        if (me.isFetched) {
            ...
            setRedirectPath(me.isSuccess ? "/manage/events" : "/event/4/masters-of-rock-25-years-of-ryan-eden");
...
export const router: RouteObject[] = [
    {
        path: "",
        element:<Navigate to="/event/4/masters-of-rock-25-years-of-ryan-eden" replace={true}/>,
